<div class="card overflow-hidden m-0">
        <div class="row justify-content-center g-0" wire:key="register-form" data-step="{{ $step }}">
            ...
            <div class="col-lg-6 tab-content">
                ...
                <div class="tab-pane fade @if($step == 3)show active @endif" id="pills-experience" role="tabpanel">
                    <div class="p-4">
                        <div class="text-center mt-2 mb-4">
                            <h5 class="text-primary">{{ __("auth.register_payment_title") }}</h5>
                            <p class="text-muted mb-1">{{ __("auth.register_payment_title_message") }}</p>
                        </div>
                        <div class="p-2">
                            <div class="mb-2">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" wire:model.lazy="name" placeholder="{{ __('global.name_placeholder') }}" required @if($loading)disabled @endif>
                                            @error('name')
                                                <span class="invalid-feedback d-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="surname" class="form-label">{{ __('global.surname') }}</label>
                                            <input type="text" class="form-control @error('surname') is-invalid @enderror" id="surname" wire:model.lazy="surname" placeholder="{{ __('global.surname_placeholder') }}" required @if($loading)disabled @endif>
                                            @error('surname')
                                                <span class="invalid-feedback d-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            <div class="mt-4">
                                <div class="hstack gap-2 justify-content-between">
                                    <button class="btn btn-outline-success w-25" type="button" wire:click="backStep" @if($loading)disabled @endif>
                                        {{ __("global.previous") }}
                                    </button>
                                    <div class="hstack flex-wrap gap-2 justify-content-end w-75">
                                        <button type="button" class="btn btn-success btn-load w-100" id="finish-button" @if($loading)disabled @endif>
                                            <span class="d-flex align-items-center">
                                                @if($loading)
                                                    <span class="spinner-border flex-shrink-0" style="margin-right: 6px" role="status">
                                                        <span class="visually-hidden">{{ __('global.next') }}</span>
                                                    </span>
                                                    <span class="flex-grow-1">{{ __('auth.processing') }}</span>
                                                @else
                                                    <span class="flex-grow-1">{{ __('global.finish') ?? __('global.next') }}</span>
                                                @endif
                                            </span>
                                        </button>
                                    </div>
                            ...
                            <p class="text-muted fs-13 text-center mt-4">
                                {{ __('auth.register_terms_message') }} <a class="text-primary" href="#">{{ __('global.terms_of_service') }}</a>
                            </p>
                        </div>
                    </div>
                </div>
